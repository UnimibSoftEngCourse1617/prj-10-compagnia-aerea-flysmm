...
<body>
	...
	var length = '<%=session.getAttribute("passengers")%>
					...
					function writeForm() {
						...
						document.write("<br><br><h1>Passenger#" + (i + 1)
								+ "</h1>");
						...
						document
								.write("                      		<label>Name<label> <input type=\"text\" name=\"name"
										+ i + "\"");
						document
								.write("							placeholder=\"name\"required><\/div>");
						document.write("  					<div class=\"field\">");
						document
								.write("						<label>Surname<\/label> <input type=\"text\" name=\"surname"
										+ i + "\"");
						document
								.write("							placeholder=\"surname\" required><\/div>");
						document.write("  					<div class=\"field\">");
						document
								.write("						<label>Fiscal code<\/label> <input type=\"text\" name=\"fiscalCode"
										+ i + "\"");
						document
								.write("							placeholder=\"fiscalcode\" required><\/div>");
						document.write("					<div class=\"field\">");
						document
								.write("						<label>Date of birth<\/label> <input type=\"date\" name=\"dateOfBirth"
										+ i + "\"");
						document
								.write("							placeholder=\"yyyy-mm-dd\" required><\/div>");
						document.write("					<div class=\"field\">");
						document
								.write("						<label>Document<\/label> <input type=\"text\" name=\"docCode"
										+ i + "\"");
						document
								.write("							placeholder=\"document code\" required><\/div>");
						document.write("					<div class=\"field\">");
						document
								.write("						<label>Document type<label> <select name=\"docType"+i+"\" class=\"ui compact selection dropdown\">");
						document
						...
						document.write("					<div class=\"field\">");
						document
								.write("                            <label>Baggage<label> <select name=\"baggage"+i+"\" class=\"ui compact selection dropdown\">");
						document
				...
				<br> <input class="ui blue submit button" type="submit"
