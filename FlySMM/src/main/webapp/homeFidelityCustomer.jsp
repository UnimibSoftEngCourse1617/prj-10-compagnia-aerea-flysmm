...
<body>
	<div class="ui stackable inverted menu">
  	...
  	<h1 class="ui center aligned header">
  		<img class="ui image "style="margin: 0 auto;" src="images/fidelity.png" >
   			HOME
			...
			<div class="ui raised segment">
				<form class="ui form" name="myObject" method="post"
					...
					<div class="field">
						...
						Start Date Program : ${customer.startDate}<br>
						Latest Book : ${customer.lastestBook}<br>
						Points Accumulated <i class="star icon"></i> : ${customer.point}<br>
					</div>
