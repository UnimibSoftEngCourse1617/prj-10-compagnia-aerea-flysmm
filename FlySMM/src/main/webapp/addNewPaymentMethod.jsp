...
<body>
	<form name="newPaymentMethod" action="#" method="post">
		<div class="field">
			<label></label> <input name="" type="text">
		</div>
		...
		<div class="field">
			<label>Data di scadenza</label> <input name="expiredDate" type="text">
		</div>
		...
		<div class="field">
			<label>Numero civico</label> <input name="street" type="text">
		</div>

		<div class="field">
			<label>cap</label> <input name="cap" type="text">
		</div>
